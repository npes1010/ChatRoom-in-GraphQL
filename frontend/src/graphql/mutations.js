...
`;
const CREATE_MESSAGE_MUTATION2 = gql`
 mutation createMessage($name1: String!, $name2: String!,$name3: String!) {
    createMessage2(name: $name1, to: $name2 , body: $name3) {
        sender
        body
        who
...
`;    
export { CREATE_CHATBOX_MUTATION, CREATE_MESSAGE_MUTATION , CREATE_MESSAGE_MUTATION2 };